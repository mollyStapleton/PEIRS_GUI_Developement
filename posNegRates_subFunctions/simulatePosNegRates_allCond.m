function [Q_out, P_out, p_risky_out, prop_accuracy] = simulatePosNegRates_allCond(Q0, alpha_p, alpha_n, beta, distType, condType)
...
%       % udpdate previous action value: Q_t+1 = Q_t + a_Q * d
        Qt(stim_chosen(i, t)) = Qt(stim_chosen(i, t)) + alpha2use * delta; 
